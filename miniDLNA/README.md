...
Copy the url of [this repository](https://github.com/Moozzuzz/HA-addons) `https://github.com/Moozzuzz/HA-addons` into [Config](https://my.home-assistant.io/redirect/config) >> [test](https://my.home-assistant.io/redirect/config/available) "Apps" >> "App-store" >> "Three dots in the right upper corner" >>"Add New repository URL". Then search for *minidlna*, select the addon and install it. 
